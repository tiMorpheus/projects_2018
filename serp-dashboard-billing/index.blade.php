...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card current-user-tariff">

                <div class="card-body">
                    <div class="current-user-tariff-header-wrap" style="display: flex">

                        <h3 class="current-user-tariff-header">Current Plan</h3>
                        <a href="{{ route('unsubscribe') }}" class="unsubscribe footer-btn footer-btn-cancel btn waves-effect waves-light btn-secondary" >Cancel</a>
                    </div>

                    <p class="current-user-tariff-description">Your currently selected plan options.</p>
            ...
            <div class="card">
                                        ...
                                        <div class="billing-cycle-btn-container">
                                            ...
                                            <div class="billing-btn-wrap">
                                                ...
                                                <button class="billing-btn  active" data-billing="month" >
                                                    ...
                                                    <div data-discount="1" class="discount">0% OFF</div>
                                                </button>
                ...
                <div class="card-footer">
                    ...
                    <div class="footer-btn-wrap">
                        <button data-tariff="" class="footer-btn  footer-btn-confirm btn waves-effect waves-light btn-primary change-tariff curr-plan-helper">Upgrade</button>

                    </div>



                    <div class="footer-btn-wrap-downgrade">
                        <button data-tariff="" class="footer-btn  footer-btn-confirm btn waves-effect waves-light btn-danger change-tariff curr-plan-helper">Downgrade</button>
        ...
        <div class="col-md-3">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-12">
                            <h3>{{ count($user->srn) }}/{{ $user->search_requests }}</h3>
                            <h6 class="card-subtitle">Keywords Tracked</h6></div>
                        <div class="col-12">
                            <div class="progress">
                                <div class="progress-bar bg-info" role="progressbar"
                                     style="width: {{ round(count($user->srn)/$user->tariff->keywords_limit*100, 1) }}%; height: 6px;"
        ...
        <div class="col-md-3">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-12">
                            <h3>{{ $user->daily_keywords_limit }}/{{ $user->search_requests }}</h3>
                            <h6 data-toggle="tooltip" data-placement="bottom"
                                title="You are allowed to upload this amount of keywords per day and receive instant updates on them today."
                                data-original-title="You are allowed to upload this amount of keywords per day and receive instant updates on them today."
                                class="card-subtitle">Instant Updates</h6></div>
                        <div class="col-12">
                            <div class="progress">
                                <div class="progress-bar bg-info" role="progressbar"
                                     style="width: {{ round(count($user->srn)/$user->tariff->keywords_limit*100, 1) }}%; height: 6px;"
        ...
        <div class="col-md-3">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-12">
                            <h3>{{ count($user->alive_projects()) }}/&#8734;</h3>
                            <h6 class="card-subtitle">Projects</h6></div>
                        <div class="col-12">
                            <div class="progress">
                                <div class="progress-bar bg-success" role="progressbar"
                                     style="width: {{ round(count($user->projects)/$user->tariff->projects_limit*100, 1) }}%; height: 6px;"
                                     aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-md-3">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-12">
                            <h3>{{ count($user->domains()) }}/&#8734;</h3>
                            <h6 class="card-subtitle">Domains Tracked</h6></div>
                        <div class="col-12">
                            <div class="progress">
                                <div class="progress-bar bg-danger" role="progressbar"
                                     style="width: {{ round(count($user->domains())/$user->tariff->domains_limit*100,1) }}%; height: 6px;"
                                     aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                        </div>
                    </div>
    ...
    <form id="form" action="{{ route('user-tariff-update') }}" method="post">
        {{ csrf_field() }}
        ...
        $( document ).ready(function() {
                ...
                if (frequency) {
                    ...
                    if (frequency.Daily) {
                        ...
                        $('.check-frequency-btn-container').append("<div class=\"billing-btn-wrap\">\n" +
                            "\n" +
                            "                    <button data-frequency='1' class=\"billing-btn active frequency daily\">Daily<div data-discount='0' class='discount'>0% OFF</div></button>\n" +
                            "\n" +
                            "\n" +
                            "\n" +
                            "                </div>")
            ...
            function refreshPrices(tariffs, frequency = 'Daily', billingcycle='month') {
                ...
                tariffs.forEach(function (item, index) {
                    ...
                    if(item.updateFrequency == frequency && item.keywords == getActiveKeywordsAmount()){
                ...
                if(tariffToShow){
                    ...
                    if(tariffToShow.tariff_id == user_tariff.tariff_id){
                        // console.log('xx');
